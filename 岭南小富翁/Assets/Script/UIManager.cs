...
public class UIManager : MonoBehaviour
{
    ...
    [Header("????¦Ë??")]
    public Vector2 diceButtonPosition = new Vector2(-20, -10); // ??????¦Ë??
    ...
    public void UpdateCurrentPlayerInfo(Player player)
    {
        ...
        {
            currentTileText.text = $"¦Ë??: {player.currentTile.tileName}";
        }
    ...
    public void SwitchUI(UIType uiType)
    {
        ...
        UnityEngine.Debug.Log($"?§Ý?UI: {uiType}");
    }
